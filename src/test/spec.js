...
(function() {
  ...
  describe("calculations", function() {
    ...
    it("adds a simple calculation", function() {
      waits(2000);
      runs(function() {
    ...
    return it("removes a simple calculation", function() {
      waits(2000);
      runs(function() {
        return this.datasets.remove_calculation("above_3rd_grade");
      });
      waits(2000);
      return runs(function() {
        var queried_data;
        queried_data = this.dataset.query_dataset().data;
        return expect(queried_data[0].above_3rd_grade).toBeUnefined();
      });
    });
  });
