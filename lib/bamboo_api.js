...
(function() {
  ...
  Dataset = (function() {
    ...
    function Dataset(data) {
      ...
      this.allowed_aggregation = ['max', 'min', 'mean', 'median', 'sum', 'ratio', 'count', 'argmax', 'newest'];
    }
    ...
    Dataset.prototype.query_info = function(sync_cb) {
      ...
      return this._run_query("info", url, !!sync_cb, function(response) {
        this.info = response;
        if (!!sync_cb) {
    ...
    Dataset.prototype.summary = function(summary_select, sync_cb) {
      var async, summary_tmp_id, url;
      ...
      url = "" + (this.bamboo_url()) + "/summary?select=" + summary_select;
      async = !!sync_cb;
      summary_tmp_id = "summary_" + summary_select;
      if (this._summaries == null) {
        this._summaries = {};
      }
      this._run_query(summary_tmp_id, url, async, function(r) {
        if (summary_select === "all") {
          this.summary_result = r;
        }
        return this._summaries[summary_tmp_id] = r;
      });
      if (async) {
        return this;
      } else {
    ...
    Dataset.prototype.select = function(obj, sync_cb) {
      ...
      this._run_query(select_tmp_id, url, async, function(r) {
        return this._selects[select_tmp_id] = r;
      });
      if (async) {
        return this;
      } else {
    ...
    Dataset.prototype.query = function(obj, sync_cb) {
      ...
      this._run_query(query_tmp_id, url, async, function(r) {
        return this._queries[query_tmp_id] = r;
      });
      if (async) {
        return this;
      } else {
    ...
    Dataset.prototype.add_calculation = function(name, formula, sync_cb) {
      ...
      if (this._is_aggregation(formula)) {
    ...
    Dataset.prototype._is_aggregation = function(formula) {
      var keyword_sel, regex, regex_str;
      keyword_sel = this.allowed_aggregation.join("|");
    ...
    Dataset.prototype.remove_aggregations = function(name) {
      return this.remove_calculation(name);
    };

    Dataset.prototype.join = function(left, right, on_column) {
      /*
      ...
      */
      ...
      return this._run_query("merging datasets " + datasets, url, false, success_cd, opts);
    };

    Dataset.prototype.merge = function(datasets) {
      /*
      ...
      */
      ...
      return this._run_query("merging datasets " + datasets, url, false, success_cd, opts, function(res) {
        return console.log(res);
      });
    };

    Dataset.prototype.update = function(rows) {
      /*
      ...
      */
      ...
      return this._run_query("updating dataset " + this.id, url, false, success_cd, opts);
    };
