...
(function() {
  ...
  Dataset = (function() {
    ...
    Dataset.prototype.add_calculation = function(name, formula, group, sync_cb) {
    ...
    Dataset.prototype.list_formulas = function() {
      ...
      success_cb = function() {
        if (dbg()) {
          return log("list_formulas success callback");
        }
      };
      return this._run_query("list_formulas", url, false, success_cb, opts);
    };
