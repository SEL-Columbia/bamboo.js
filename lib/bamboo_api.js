...
(function() {
  var Dataset, LS, allowed_aggregation, bamboo_url, dataset_exists, dbg, ensure_jquery, is_aggregation, jsonify, noop, settings, _add_aggregation, _add_calculation, _create_dataset, _delete_dataset, _query, _query_aggregations, _query_calculations, _query_info, _remove_aggregation, _remove_calculation, _run_query, _summary, _uniqueId, _uniqueIdCount,
    __slice = [].slice;
