...
(function() {
  ...
  Dataset = (function() {
    ...
    Dataset.prototype.remove_calculation = function(name) {
      ...
      url = bamboo_url("calculations", this.id, name);
      success_cb = function(response) {
        if (dbg()) {
          return log(response.success);
        }
    ...
    Dataset.prototype.merge = function(datasets) {
      ...
      */
      ...
      return this._run_query("merging datasets " + datasets, url, false, success_cb, opts, function(res) {
    ...
    Dataset.prototype.update = function(rows) {
      ...
      */
      ...
      return this._run_query("updating dataset " + this.id, url, false, success_cb, opts);
    };
